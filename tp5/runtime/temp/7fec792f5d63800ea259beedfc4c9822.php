<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"D:\phpStudy\WWW\tp5\public/../application/admin\view\community\add.html";i:1516155253;}*/ ?>
<!DOCTYPE html>
...
<head>
    ...
    <script type="text/javascript" src="/admin/static/Css/jquery.js"></script>
    <script type="text/javascript" src="/admin/static/Css/jquery.sorted.js"></script>
    <script type="text/javascript" src="/admin/static/Css/bootstrap.js"></script>
    <script type="text/javascript" src="/admin/static/Css/ckform.js"></script>
    <script type="text/javascript" src="/admin/static/Css/common.js"></script>
    <style type="text/css">
        body {
            padding-bottom: 40px;
        }
