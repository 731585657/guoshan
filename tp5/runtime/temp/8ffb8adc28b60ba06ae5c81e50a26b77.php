<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"D:\phpStudy\WWW\tp5\public/../application/admin\view\community\index.html";i:1515477199;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <title></title>
...
<form class="form-inline definewidth m20" action="index.html" method="get">
    <a href="<?php echo url('Community/add'); ?>"><button type="button" class="btn btn-success" id="addnew">新增用户</button></a>
</form>
<table class="table table-bordered table-hover definewidth m10">
    ...
    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$community): $mod = ($i % 2 );++$i;?>
    <tr>
        <td><?php echo $community['id']; ?></td>
        <td><?php echo $community['title']; ?></td>
        <!--<td><?php echo $community['content']; ?></td>-->
        <td><?php echo $community['status']==1?"正常":"失效"; ?></td>
        <td><?php echo $community['weight']; ?></td>
        <td><?php echo date("Y-m-d H:i:s",$community['create_time']); ?></td>
        <td>
            <a href="<?php echo url('edit?id='.$community['id']); ?>">编辑</a>
            <a href="<?php echo url('del?id='.$community['id']); ?>">删除</a>
